...
public class AfterProducerProcessingConfiguration {
    ...
    @Bean(name = VALIDATOR_AFTER_PRODUCER_COMPONENT_NAME)
    @ConditionalOnBean(name = JSON_VALIDATOR_AFTER_PRODUCER_CONFIGURATION)
    public JsonValidatorComponent jsonValidatorAfterProducerComponent() {
    ...
    // transform
    @ConfigurationProperties(prefix = FREEMARKER_AFTER_PRODUCER_CONFIGURATION_PATH)
    @ConditionalOnProperty(value = FREEMARKER_AFTER_PRODUCER_CONFIGURATION_PATH + ".resource-uri")
    @Bean(FREEMARKER_AFTER_PRODUCER_CONFIGURATION)
    public FreemarkerProducerConfiguration freemarkerConfiguration() {
        return new FreemarkerProducerConfiguration();
    }

    @Bean(name = FREEMARKER_AFTER_PRODUCER_COMPONENT_NAME)
