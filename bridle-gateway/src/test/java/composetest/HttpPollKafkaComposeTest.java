...
class HttpPollKafkaComposeTest {

    private static final String ROUTE_NAME = GATEWAY_TYPE_HTTP_POLL_KAFKA;

    private static final Predicate<String> APP_STARTS_TO_RECIEVE_LOAD_PREDICATE =
            s -> parseMessagesAmount(s, ROUTE_NAME) > 0;

    private static final String COMPOSE_FILE_PATH = "compose/demo-http-poll-kafka-compose.yml";
