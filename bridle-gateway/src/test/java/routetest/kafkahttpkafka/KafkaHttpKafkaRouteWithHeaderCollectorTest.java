...
@TestPropertySource(properties = {
        "spring.config.location=classpath:routetest/kafka-http-kafka/application-with-header-collector.yml"})
@CamelSpringBootTest
@DirtiesContext
@Testcontainers
@AutoConfigureMetrics
public class KafkaHttpKafkaRouteWithHeaderCollectorTest {
    ...
    @Test
    void verifySuccessKafkaHttpKafkaScenarioWithFullProcessingWithHeaderCollectors() throws Exception {
        int messageCount = 1;
